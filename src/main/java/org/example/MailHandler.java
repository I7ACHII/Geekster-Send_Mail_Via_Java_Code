...
public class MailHandler {
    void sendMail(){
        // properties class is of hashmap type
...
//        mime message build
        ...
        try {
            ...
            mailMessage.setText("Hello! Tanish Singh Thakor. How you doing?");

            //        Set the reciever
            Address recieverEmail = new InternetAddress(MailMetaData.recieverMail);
            mailMessage.setRecipient(Message.RecipientType.TO, recieverEmail);
